<script>
    ...
    import AddStratCategoryForm from './AddStratCategoryForm.svelte'
    ...
    function addSecondLevelView(name, filter) {
    ...
    <Column name='Second Level Startification'>
        <div slot="action" class="p-1 mb-1 border-b w-full flex justify-between gap-x-2 h-12">
            {#if data.views.length > 0}
                <select id="secondLevelStrat" class="border rounded-md p-1 w-full bg-white" bind:value={selectedView}>
